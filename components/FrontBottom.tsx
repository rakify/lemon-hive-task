      ...
      <div className="fb hidden sm:flex flex-row gap-3 pl-4 pr-4">
        <div className="flex flex-col gap-3" style={{ flex: 6 }}>
          <div className="flex flex-row gap-3">
            <div className="flex flex-col gap-3" style={{ flex: 6 }}>
              <div className="">
                1 Lorem ipsum dolor sit amet consectetur. Risus cursus nibh
              ...
              <div className="flex flex-row gap-3">
                <div className="" style={{ flex: 3 }}>
                  2 Lorem ipsum dolor sit amet consectetur. Turpis integer massa
              ...
              <div style={{ flex: 1 }}>
                4 Lorem ipsum dolor sit amet consectetur. Tincidunt at cras
                tortor non volutpat quisque facilisis. Ultricies consequat sed
                vitae ac. Nisl eu nam id lectus tellus sit egestas. Orci iaculis
                et vehicula nisi facilisi neque lorem. In vulputate feugiat
            ...
            <div className="flex flex-col gap-3" style={{ flex: 2 }}>
              <img className="w-[200px] h-[200px]" src="/images/Image03.png" />
              <img className="w-[200px] h-[200px]" src="/images/Image02.png" />
            </div>
          </div>

          <div>
            7 At a enim parturient id. Suspendisse ullamcorper fermentum
            ...
            amet tristique tellus. Sed quam aliquam pharetra nunc ipsum mattis.
            Volutpat pellentesque cras euismod habitant sit nibh. Dictum odio at
            aliquam sed. Orci odio lacinia id sem sed suspendisse mi fringilla
            purus. Quis sed ultricies ac nullam odio. Gravida sollicitudin
            viverra ornare pretium etiam tortor imperdiet tellus. Id purus etiam
            nunc hendrerit quam in. Dui netus lectus nulla cursus ultrices
            nulla. Morbi sit in gravida fermentum. Non sed lobortis amet eget
            sed donec.At a enim parturient id. Suspendisse ullamcorper fermentum
            accumsan diam tellus. Nibh pretium ultrices scelerisque dolor at
            etiam lectus gravida sed. Sit in turpis suspendisse et aliquam.
            Vulputate sit phasellus proin eget arcu. Enim nec ante velit erat
            nibh nunc amet. Tellus at sit imperdiet non. Cras dictum curabitur
        ...
        <div className="flex flex-col gap-3" style={{ flex: 4 }}>
          <div>
            8 Lorem ipsum dolor sit amet consectetur. Risus cursus nibh
            ...
            scelerisque. Proin pretium gravida semper ut erat nisi. Pulvinar ac
            mattis porta amet et. Nisl urna non fames felis leo. Vitae pulvinar
            sed viverra .
          </div>
          <div className="flex flex-row gap-3">
            <img className="w-[200px] h-[200px]" src="/images/Image05.png" />
            <div>
              10 Lorem ipsum dolor sit amet consectetur. Risus cursus nibh
              elementum ornare a aliquet ac. Feugiat scelerisque ultrices tempor
              facilisi tempus risus nunc. Proin quis morbi posuere nisl etiam
          ...
          <div className="flex flex-row gap-3">
            <img className="w-[200px] h-[200px]" src="/images/Image01.png" />
            <div>
              12 Lorem ipsum dolor sit amet consectetur. Risus cursus nibh
              elementum ornare a aliquet ac. Feugiat scelerisque ultrices tempor
              facilisi tempus risus nunc. Proin quis morbi posuere nisl etiam
              scelerisque. Proin pretium gravida semper ut erat nisi. Pulvinar
              ac mattis porta amet et. Nisl urna non fames felis leo. Vitae
          ...
          <p>
            13 At a enim parturient id. Suspendisse ullamcorper fermentum
            accumsan diam tellus. Nibh pretium ultrices scelerisque dolor at
            etiam lectus gravida sed. Sit in turpis suspendisse et aliquam.
          </p>
          <p>
            14 At a enim parturient id. Suspendisse ullamcorper fermentum
            accumsan diam tellus. Nibh pretium ultrices scelerisque dolor at
            etiam lectus gravida sed. Sit in turpis suspendisse et aliquam.
            Vulputate sit phasellus proin eget arcu. Enim nec ante velit erat
            nibh nunc amet. Tellus at sit imperdiet non. Cras dictum curabitur
