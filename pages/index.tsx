        ...
        <div style={{ flex: 20 }}>
          ...
          <div className="space-y-5 relative m-[30px]">
            <div className="w-[70%] ">
              ...
              quam harum nesciunt, numquam reiciendis similique repellendus
              accusamus tempore assumenda quidem ad laborum. Unde quisquam
              voluptate sed saepe dolor labore adipisci.
            </div>
            ...
            <div className="w-[45%]">
              ...
              Consequatur sit repellendus officia officiis atque voluptate culpa
              corporis dignissimos hic libero accusamus ullam aut,
              necessitatibus minus aliquam dolor maxime recusandae voluptatibus
              excepturi fuga nostrum sint laborum! Debitis optio architecto
              cumque provident. Quidem dolorum id unde inventore eum eaque
              fugiat maxime nam.
            </div>
            ...
            <div className="w-[70%]">
              ...
              blanditiis voluptates, officiis corporis animi nostrum ex
              asperiores, magni facere quos, rerum dignissimos. Expedita,
              nostrum error?
            </div>
            ...
            <div className="pt-4">
              ...
              laborum iste debitis libero suscipit quibusdam non cupiditate
              omnis aperiam temporibus perferendis consequatur velit, eligendi
              voluptates atque, rem mollitia, at rerum ex. Blanditiis,
              repellendus. Saepe dolor sequi repellendus cupiditate hic porro
              nisi sunt, molestias tempore dolorum maxime recusandae placeat.
              Deleniti vel necessitatibus n praesentium mollitia ipsum
              necessitatibus autem possimus nemo, dolorem at minima placeat
              repellat debitis eligendi fugit reiciendis tempora! Dolor natus ex
              culpa, magnam nisi in sequi optio illo eum maiores delectus facere
              quae adipisci nobis deleniti at sint, sunt voluptatibus. Sit quas
              possimus beatae? Cupiditate inventore necessitatibus optio
              delectus laudantium quis. Culpa recusandae vel necessitatibus nisi
              ab, quos magnam libero omnis accusantium neque iusto eligendi
              labore mollitia eius.
            </div>
          </div>
        </div>
        <div
